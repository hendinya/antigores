...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h5 mb-0">Brands</h1>
        <a href="{{ route('admin.brands.create') }}" class="btn btn-dark btn-sm">Tambah</a>
    </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-0">
            <table class="table mb-0">
                ...
                @empty
                    <tr><td colspan="4" class="text-center py-4 text-secondary">Belum ada brand.</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
